...
class PropertyLookupStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.AddressByParcel = channel.unary_unary(
...
def add_PropertyLookupServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'property.PropertyLookup', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('property.PropertyLookup', rpc_method_handlers)
